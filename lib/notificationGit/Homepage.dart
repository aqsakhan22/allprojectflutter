...
import '../exampleNototifications.dart';
import 'InfoValueString.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _showNotification() async {
    ...
    await flutterLocalNotificationsPlugin.show(id++, 'plain title', 'plain body', notificationDetails, payload: 'data with payload paramater');
  }
