...
// import 'package:flutter/material.dart';
// import 'package:notificationflutter/notificationService.dart';
...
//             _counter=_counter+1;
//             NotificationService().showNotification(id:_counter,title: "Hedllo", body: "hjiljiui", payload: 'payload');
//
//             // NotificationService().notification.getActiveNotifications().then((value){
//             //   print("Notifications is length ${value.length}");
//             //   value.forEach((element) {
//             //
//             //     print("notifications list is ${element.body}");
//             //   });
//             // });
//
//           }, child: Text("Check Notiifcation"))
//         ],
