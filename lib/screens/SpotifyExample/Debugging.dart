...
import 'package:runwith/screens/SpotifyExample/widgets/sized_icon_button.dart';
...
class SpotifyExample extends StatefulWidget {
  const SpotifyExample({Key? key}) : super(key: key);

  @override
  State<SpotifyExample> createState() => _SpotifyExampleState();
}

class _SpotifyExampleState extends State<SpotifyExample> {
  bool _loading = false;
  ...
  Widget _buildPlayerStateWidget() {
    return StreamBuilder<PlayerState>(
      ...
      builder: (BuildContext context, AsyncSnapshot<PlayerState> snapshot) {
        print("Player data is ${snapshot.data}");
  ...
  Widget _buildPlayerContextWidget() {
    return StreamBuilder<PlayerContext>(
      ...
      builder: (BuildContext context, AsyncSnapshot<PlayerContext> snapshot) {
        ...
        print("data in player${snapshot.data == null}");
  ...
  Future<void> disconnect() async {
    try {
      ...
      setStatus('disconnect not implemented');
    }
  }
  ...
  Future<void> connectToSpotifyRemote() async {
    try {
      ...
      setStatus('connectToSpotifyRemote not implemented');
    }
  }
  ...
  Future<String> getAccessToken() async {
    try {
      ...
      setStatus('getAccessToken not implemented');
  ...
  Future getPlayerState() async {
    try {
      ...
      setStatus('getPlayerState not implemented');
    }
  }
  ...
  Future getCrossfadeState() async {
    try {
      ...
      setStatus('getCrossfadeState not implemented');
    }
  }
  ...
  Future<void> queue() async {
    try {
      ...
      setStatus('queue not implemented');
    }
  }
  ...
  Future<void> toggleRepeat() async {
    try {
      ...
      setStatus('toggleRepeat not implemented');
    }
  }
  ...
  Future<void> setRepeatMode(RepeatMode repeatMode) async {
    try {
      ...
      setStatus('setRepeatMode not implemented');
    }
  }
  ...
  Future<void> setShuffle(bool shuffle) async {
    try {
      ...
      setStatus('setShuffle not implemented');
    }
  }
  ...
  Future<void> toggleShuffle() async {
    try {
      ...
      setStatus('toggleShuffle not implemented');
    }
  }
  ...
  Future<void> play() async {
    try {
      ...
      setStatus('play not implemented');
    }
  }
  ...
  Future<void> pause() async {
    try {
      ...
      setStatus('pause not implemented');
    }
  }
  ...
  Future<void> resume() async {
    try {
      ...
      setStatus('resume not implemented');
    }
  }
  ...
  Future<void> skipNext() async {
    try {
      ...
      setStatus('skipNext not implemented');
    }
  }
  ...
  Future<void> skipPrevious() async {
    try {
      ...
      setStatus('skipPrevious not implemented');
    }
  }
  ...
  Future<void> seekTo() async {
    try {
      ...
      setStatus('seekTo not implemented');
    }
  }
  ...
  Future<void> seekToRelative() async {
    try {
      ...
      setStatus('seekToRelative not implemented');
    }
  }
  ...
  Future<void> addToLibrary() async {
    try {
      ...
      setStatus('addToLibrary not implemented');
    }
  }
  ...
  Future<void> checkIfAppIsActive(BuildContext context) async {
    try {
      ...
      setStatus('checkIfAppIsActive not implemented');
    }
  }
